...
1. `src/themes/presets/your-theme.ts`에 `ThemeTokens` 구현
2. `src/themes/index.ts`에 등록

### 새 템플릿 추가

1. `src/templates/your-template.ts`에 렌더 함수 작성
2. `src/templates/index.ts`에 등록
3. 템플릿 메타데이터에 미리보기 설정 추가
